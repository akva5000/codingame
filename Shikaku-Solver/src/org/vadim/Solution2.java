...
public class Solution2 {
	...
	public static void main(String args[]) {
		...
		for (List<Rect> l : variation) {
			System.err.print("" + l.size() + " x ");
		}
		System.err.println();
		...
		String[] solutions;
		{
			...
			List<Rect> variant = new ArrayList<>(numbers.length);
			for (int i = 0; i < numbers.length; i++) variant.add(new Rect(0, 0, 0, 0, i));
