...
public class Solution4 {
	...
	public static void main(String args[]) {
		...
		for (int i = 0; i < numbers.length; i++) {
			generateCombinations(numbers, i, variation);
		}
	...
	private static String[] evaluateSolutions(List<List<Rect>> variation) {
	...
	private static void generateCombinations(final Point[] numbers, int idx, List<List<Rect>> variation) {
