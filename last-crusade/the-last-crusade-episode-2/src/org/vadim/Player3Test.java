...
//		TURN: 2,0 / T
		...
		LinkedList<int[]> rc = Player3.calculateStrategy(2, 1, 2, grid, isRoomRotate);
		System.err.flush();
		printResult(rc);
	} 
...
//	Turn: 1,0 / T
		...
		LinkedList<int[]> rc = Player3.calculateStrategy(1, 1, 1, grid, isRoomRotate);
		printResult(rc);
	}
...
//  Turn: 1,0 / T
	...
	public void testMain4() {
		...
		LinkedList<int[]> rc = Player3.calculateStrategy(0, 1, 2, grid, isRoomRotate);
		printResult(rc);
	}
