...
//		TURN: 2,0 / T
		...
		LinkedList<int[]> rc = Player1.calculateStrategy(2, 0, 1, 3, 5, 2, grid, isRoomRotate);
		printResult(rc);
	} 
...
//  Turn: 1,0 / T
		...
		LinkedList<int[]> rc = Player1.calculateStrategy(1, 0, 1, 4, 8, 1, grid, isRoomRotate);
		printResult(rc);
	}
	...
	public void testMain3() {
		...
		LinkedList<int[]> rc = Player1.calculateStrategy(0, 0, 1, 10, 13, 2, grid, isRoomRotate);
		printResult(rc);
	}
